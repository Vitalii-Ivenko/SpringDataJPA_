...
import jpa.repository.SpringDataOwnerRepository;
...
public class SpringDataJpaTest {
    ...
    public void setUp(){
        ...
        Device d3 = new Device(800, "iPhone 6+", "Grey", 64, o2);
        Device d4 = new Device(1250, "MacBook", "White", 256, o2);
        ...
        Device d5= new Device(600, "iPhone 5s", "Black", 64, o3);
    ...
    public void testFindByDevices() {
        ...
        final Device device = new Device(300,testDeviceName,"Green",256,john);
...
//
    ...
    public void testFindByPrice() {
        ...
        Owner o1 = new Owner("Abadon", "Rik",22);
        Device d3 = new Device(90, "iPhone 6+", "Grey", 64, o1);
        Device d4 = new Device(90, "iPod", "White", 64, o1);
        Set<Device> devices = new HashSet<Device>();
        devices.add(d3);
        devices.add(d4);
        o1.setDevices(devices);
        ...
        Owner o2 = new Owner("Brandon", "Fetch",25);
        Device d1 = new Device(90, "Nexxus 5", "Grey", 128, o2);
        Device d2 = new Device(90, "Galaxy Note 3", "White", 128, o2);
        ...
        Owner o3 = new Owner("William", "May",55);
        Device d5 = new Device(90, "Galaxy Note 3", "White", 128, o2);
